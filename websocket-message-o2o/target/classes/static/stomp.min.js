...
(function () {
    ...
    e = function () {
        ...
        r.prototype.debug = function (t) {
            var e;
            return typeof window !== "undefined" && window !== null ? (e = window.console) != null
                ? e.log(t) : void 0 : void 0
        };
        e = function () {
            if (Date.now) {
                return Date.now()
        ...
        r.prototype.connect = function () {
            ...
            this.ws.onmessage = function (i) {
                return function (r) {
                    ...
                    c =
                        typeof ArrayBuffer !== "undefined" && r.data instanceof ArrayBuffer ? (o =
                            new Uint8Array(r.data), typeof i.debug === "function" ? i.debug(
                            "--- got data length: " + o.length) : void 0, function () {
                            var t, e, n;
                            n = [];
                    ...
                    for (g = 0, b = m.length; g < b; g++) {
                        ...
                        switch (f.command) {
                            case"CONNECTED":
                                ...
                                v.push(
                                    typeof i.connectCallback === "function" ? i.connectCallback(f)
                                        : void 0);
                                break;
                            case"MESSAGE":
                                ...
                                if (l) {
                                    ...
                                    v.push(typeof i.debug === "function" ? i.debug(
                            ...
                            default:
                                v.push(
                                    typeof i.debug === "function" ? i.debug("Unhandled frame: " + f)
                                        : void 0)
                        }
                    }
                    return v
